...
export class SharedService {
  ...
  events: EventItem[] = [
    ...
    {
      pics: ['..\\assets\\dansinritmi\\dr1.jpg','..\\assets\\dansinritmi\\dr2.jpg','..\\assets\\dansinritmi\\dr3.jpg'], date: "2022-08-02", venue: "Hodjapasha Dance Theater", location: "İzmir", category: "Bale", artist: "Dansın Ritmi", ticketPrice: [100,200,300], isPopular: false
    },
    {
